...
#'
#' @param url [list] List containing URLs for SIRIUS examples (must have $v5 and
#'     $v6 elements)
#' @param export [list] List containing export paths for SIRIUS examples (must
#'     have $v5 and $v6 elements)
#'
