...
#'     level based on organism occurrence data.
#'
...
decorate_bio <- function(
  ...
  n_kingdom <- count_structures_at_level(annot_table_wei_bio, score_biological_kingdom)
  n_phylum <- count_structures_at_level(annot_table_wei_bio, score_biological_phylum)
  n_class <- count_structures_at_level(annot_table_wei_bio, score_biological_class)
  n_order <- count_structures_at_level(annot_table_wei_bio, score_biological_order)
  n_family <- count_structures_at_level(annot_table_wei_bio, score_biological_family)
  n_tribe <- count_structures_at_level(annot_table_wei_bio, score_biological_tribe)
  n_genus <- count_structures_at_level(annot_table_wei_bio, score_biological_genus)
  n_species <- count_structures_at_level(annot_table_wei_bio, score_biological_species)
  n_variety <- count_structures_at_level(annot_table_wei_bio, score_biological_variety)

  # Log summary statistics
  logger::log_info(
    "Taxonomically informed metabolite annotation reranked:\n",
    "  Kingdom level: ", n_kingdom, " structures\n",
    "  Phylum level:  ", n_phylum, " structures\n",
    "  Class level:   ", n_class, " structures\n",
    "  Order level:   ", n_order, " structures\n",
    "  Family level:  ", n_family, " structures\n",
    "  Tribe level:   ", n_tribe, " structures\n",
    "  Genus level:   ", n_genus, " structures\n",
    "  Species level: ", n_species, " structures\n",
    "  Variety level: ", n_variety, " structures"
  )
