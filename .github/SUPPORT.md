...
Thanks for using tima! Before filing an issue, there are a few places to explore
...
- If it's a bug: you're in the right place, [file an
  issue](https://github.com/taxonomicallyinformedannotation/tima/issues/new).

- If you're not sure: let the community help you figure it out! If your problem
  *is* a bug or a feature request, you can easily return here and report it.

Before opening a new issue, be sure to [search issues and pull
requests](https://github.com/taxonomicallyinformedannotation/tima/issues) to
