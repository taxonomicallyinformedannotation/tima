# Contributing to timaR

This outlines how to propose a change to timaR.
...
If you haven't done this before, we recommend using `usethis::create_from_github("taxonomicallyinformedannotation/tima-r", fork = TRUE)`.
...
Please note that the timaR project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md).
