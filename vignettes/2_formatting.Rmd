...
For the moment, we support annotations coming from 3 different annotation tools: GNPS, SIRIUS, and our *in lab* developed tool, **ISDB**.
...
We now recommend you to read the [next vignette](https://taxonomicallyinformedannotation.github.io/tima-r/articles/3_processsing.html).
