...
If you want to know how we attempt to combine the CSI score with other ones, see [R/transform_score_sirius_csi.R](https://github.com/taxonomicallyinformedannotation/tima-r/blob/main/R/transform_score_sirius_csi.R)
