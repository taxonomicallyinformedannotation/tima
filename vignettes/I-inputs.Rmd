---
title: "1 Inputs: Getting everything you need"
author: "Adriano Rutz"
date: "`r Sys.Date()`"
...
opengraph:
    ...
    twitter:
      creator: "@adafede"
vignette: >
  %\VignetteIndexEntry{1 Inputs: Getting everything you need}
...
To get some example files (corresponding to the spectra to annotate, corresponding areas and metadta), just run:
...
Finally, you need spectral libraries to perform MS^2^-based annotation.
