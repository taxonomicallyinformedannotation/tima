...
Some pre-defined parameters are given in `tools/default` directory.
...
The values you adapted in `tools/prepare_params.yaml` were automatically propagated to all sub-files in `tools/user`.
...
Before running the corresponding code, do not forget to modify `tools/user/prepare_libraries_sop_closed.yaml`
...
Before running the corresponding code, do not forget to modify `tools/user/prepare_libraries_sop_merged.yaml`.
...
Before running the corresponding code, do not forget to modify `tools/user/prepare_libraries_adducts.yaml`.
...
Finally, you need a spectral library to perform MS^2^-based annotation.
