...
paths$urls$examples$mgf <- paths$urls$examples$mgf_mini
...
```{r}
source(file = "tima-r/inst/scripts/prepare_config.R")
```
...
Before running the corresponding code, do not forget to modify `config/user/prepare_library.yaml`.
