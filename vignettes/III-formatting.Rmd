...
Before running the corresponding code, do not forget to modify `params/user/prepare_features_tables.yaml`, `params/user/prepare_features_edges.yaml`, `params/user/create_components.yaml`, and `params/user/prepare_features_components.yaml` accordingly.
