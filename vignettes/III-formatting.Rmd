...
Before running the corresponding code, do not forget to modify `tools/user/prepare_*yourAnnotationTool*.yaml`.
...
Before running the corresponding code, do not forget to modify `tools/user/prepare_features_tables.yaml`, `tools/user/prepare_features_edges.yaml`, `tools/user/create_components.yaml`, and `tools/user/prepare_features_components.yaml` accordingly.
...
Before running the corresponding code, do not forget to modify `tools/user/prepare_taxa.yaml`.
