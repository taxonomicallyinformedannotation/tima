...
targets::tar_visnetwork(
  names = starts_with("annotations_ms1"),
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
targets::tar_visnetwork(
  names = starts_with("annotations_spectral_is"),
  exclude = c(contains("par_")),
  targets_only = TRUE,
  degree_from = 8
)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
targets::tar_visnetwork(
  names = starts_with("annotations_spectral"),
  exclude = c(contains("par_")),
  targets_only = TRUE,
  degree_from = 8
)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
targets::tar_visnetwork(
  names = starts_with("annotations_s"),
  exclude = c(contains("par_")),
  targets_only = TRUE,
  degree_from = 8
)
