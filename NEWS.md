...
* **Adduct canonicalization alignment**:
  ...
  - Improved ammonium/loss semantic reduction in harmonization (e.g., `[M-H5NO+H4N]+ -> [M-H2O+H]+`, `[M-H3N+C2H7N+H4N]+ -> [M+C2H7N+H]+`) to reduce duplicated/over-complex carrier notation
