...
As the package is not (yet) available on CRAN, you will need to install the development version [GitHub](https://github.com/) with:
...
In case you do not have your data ready, you can obtain some example data (set of 5,000+ spectra) using:
